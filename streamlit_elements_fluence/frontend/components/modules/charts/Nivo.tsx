...
const elements: ElementsRecord = {
  ...
  Icicle: dynamic(() => import("@nivo/icicle").then(m => m.ResponsiveIcicle), { loading: ElementsLoading, ssr: false }),
  IcicleHtml: dynamic(() => import("@nivo/icicle").then(m => m.ResponsiveIcicleHtml), { loading: ElementsLoading, ssr: false }),
